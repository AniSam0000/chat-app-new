              ...
              <div className="">
                ...
                {msg.senderId === authUser._id && (
                  <button
                    ...
                    className="absolute top-0.5 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-xs bg-red-400 text-white px-2 py-1 rounded-md"
                  >
                    Delete
                  </button>
                )}
